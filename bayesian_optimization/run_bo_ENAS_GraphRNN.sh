...
#SBATCH --job-name=GraphRNN          # Job name
#SBATCH --output=GraphRNN_output_%j.txt # Standard output log, %j will be replaced with job ID
#SBATCH --error=GraphRNN_error_%j.txt   # Standard error log, %j will be replaced with job ID
